...
- `im2300-top-panel-layout-rev-h.svg` - current connector-placement concept. It
  ...
  the 8x8 XLR bank, Gold Mount keepout, eight RF bulkheads, four Ethernet ports,
...
- `mechanical/im2300-underside-pcb-floorplan-rev-g.svg` - current pre-routing
  ...
  bodies plus fused 12 V harness route for the independent panel lights.
