...
| 2 | Cellular-modem fan | `MODEM_FAN_PWM` | `MODEM_FAN_TACH` | Delta `AFB0412SHB-SP04`, 40 x 40 x 15 mm |
...
The CPU and modem fan frequencies must be taken from their released fan
